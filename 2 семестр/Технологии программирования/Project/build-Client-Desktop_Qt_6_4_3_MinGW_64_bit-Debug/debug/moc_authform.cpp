...
Q_CONSTINIT static const qt_meta_stringdata_AuthForm_t qt_meta_stringdata_AuthForm = {
    {
        ...
        QT_MOC_LITERAL(9, 8),  // "onClosed"
        QT_MOC_LITERAL(18, 0),  // ""
        QT_MOC_LITERAL(19, 22),  // "on_but_sign_up_clicked"
        QT_MOC_LITERAL(42, 22),  // "on_but_sign_in_clicked"
        QT_MOC_LITERAL(65, 19),  // "on_but_exit_clicked"
        QT_MOC_LITERAL(85, 10)   // "check_auth"
    },
    "AuthForm",
    "onClosed",
    "",
    "on_but_sign_up_clicked",
    "on_but_sign_in_clicked",
    "on_but_exit_clicked",
    "check_auth"
};
...
Q_CONSTINIT const QMetaObject AuthForm::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_AuthForm_t,
        ...
        // method 'on_but_sign_up_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_but_sign_in_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void AuthForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->onClosed((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 1: _t->on_but_sign_up_clicked(); break;
        case 2: _t->on_but_sign_in_clicked(); break;
        case 3: _t->on_but_exit_clicked(); break;
        case 4: _t->check_auth(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &AuthForm::onClosed; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void AuthForm::onClosed(QString _t1)
{
